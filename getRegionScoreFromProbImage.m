function [regionUnary,regionSizes] = getRegionScoreFromProbImage(...
    membraneProbabilityMap,mitochondriaProbabilityImage,...
    useMitochondriaDetection,addMarginThickness,addMarginValue,...
    setOfCells,sizeR,sizeC,...
    wsIndsForCells,ws,showImg,saveIntermediateImages,...
...
neuronProbabilityMap = invertImage(membraneProbabilityMap);
...
[regionUnary,~,regionSizes] = getCellPriors_probability(neuronProbabilityMap,setOfCells,...
